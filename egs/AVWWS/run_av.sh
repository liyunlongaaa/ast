...
fstride=10
tstride=10
tr_data=./data/datafiles/AVWWS_train_data.json
val_data=./data/datafiles/AVWWS_dev_data.json
eval_data=./data/datafiles/AVWWS_eval_data.json
...
--label-csv ./data/AVWWS_class_labels_indices.csv --n_class 2 \
